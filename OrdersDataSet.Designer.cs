...
namespace Spris.Sample1 {
    ...
    public partial class OrdersDataSet : global::System.Data.DataSet {
        ...
        public partial class OrdersDataTable : global::System.Data.TypedTableBase<OrdersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public OrdersRow AddOrdersRow(System.DateTime OrderDate, string UserID, string UserName, string ProductList) {
            ...
            private void InitClass() {
                ...
                this.columnProductList.MaxLength = 2147483647;
            }
        ...
        public partial class OrdersRow : global::System.Data.DataRow {
            ...
            public string ProductList {
                get {
                    try {
                        return ((string)(this[this.tableOrders.ProductListColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("資料表 \'Orders\' 中資料行 \'ProductList\' 的值是 DBNull。", e);
                    }
                }
                set {
                    this[this.tableOrders.ProductListColumn] = value;
                }
            }
            ...
            public bool IsProductListNull() {
                return this.IsNull(this.tableOrders.ProductListColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetProductListNull() {
                this[this.tableOrders.ProductListColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Spris.Sample1.OrdersDataSetTableAdapters {
    ...
    public partial class OrdersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("ProductList", "ProductList");
            this._adapter.TableMappings.Add(tableMapping);
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Orders] ([OrderDate], [UserID], [UserName], [ProductList]) VALUES (@" +
                "OrderDate, @UserID, @UserName, @ProductList)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ProductList", global::System.Data.SqlDbType.Text, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ProductList", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT          OrderID, OrderDate, UserID, UserName, ProductList\r\nFROM          " +
                "    Orders\r\nWHERE          (UserID = @UserID)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@UserID", global::System.Data.SqlDbType.VarChar, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UserID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(OrdersDataSet.OrdersDataTable dataTable, string UserID) {
        ...
        public virtual OrdersDataSet.OrdersDataTable GetData(string UserID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((UserID == null)) {
                throw new global::System.ArgumentNullException("UserID");
            }
        ...
        public virtual int Insert(System.DateTime OrderDate, string UserID, string UserName, string ProductList) {
            ...
            if ((ProductList == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(ProductList));
            }
